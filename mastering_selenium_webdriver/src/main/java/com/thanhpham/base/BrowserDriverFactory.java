...
public class BrowserDriverFactory {
	...
	// to get the URL address, run the command below: 
	//C:\Users\thanh\git\mastering_selenium_webdriver\mastering_selenium_webdriver\src\main>java
	// -jar selenium-server-standalone-3.141.59.jar -role hub
	...
	public WebDriver createDriverGrid() {
		...
		URL url = null;
		try {
			url = new URL("http://192.168.1.70:4444/wd/hub");
