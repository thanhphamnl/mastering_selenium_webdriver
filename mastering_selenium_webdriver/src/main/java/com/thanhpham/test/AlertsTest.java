...
public class AlertsTest extends BaseTest {
	...
	public void jSAlertConfirmTest() {
		...
		Assert.assertTrue(
				threeSecondsWait
						.until(ExpectedConditions.textToBePresentInElementLocated(By.id("result"), "You clicked: Ok")),
				"Result text is not expected!");
	...
	public void jSAlertCancelTest() {
		...
		WebDriverWait threeSecondsWait = new WebDriverWait(driver, 3);
		Assert.assertTrue(
				threeSecondsWait.until(
						ExpectedConditions.textToBePresentInElementLocated(By.id("result"), "You clicked: Cancel")),
				"Result text is not expected!");
	...
	public void jSAlertPromptTest() {
		...
		// Verification 2: Correct result text
		WebDriverWait threeSecondsWait = new WebDriverWait(driver, 3);
		Assert.assertTrue(threeSecondsWait.until(
				ExpectedConditions.textToBePresentInElementLocated(By.id("result"), "You entered: Hello, world!")),
				"Result text is not expected!");
